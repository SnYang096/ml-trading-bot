...
- `docs/architecture/strategies/SEMANTIC_GROUPS_SINGLETON_EXPANSION.md`：Semantic groups 单例展开详细说明
- `docs/architecture/strategies/RECOMMENDED_FEATURE_WORKFLOW.md`：推荐的特征工作流
