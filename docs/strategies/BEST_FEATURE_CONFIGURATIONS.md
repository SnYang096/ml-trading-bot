...
详细文档：`docs/strategies/SEMANTIC_VS_POOLB_WORKFLOW.md`
...
- **实验协议**：
  - `docs/strategies/SR_REVERSAL_EXPERIMENT_PROTOCOL.md`
  - `docs/strategies/SR_BREAKOUT_EXPERIMENT_PROTOCOL.md`
- **架构文档**：
