...
建议先读：
- `docs/guides/FEATURE_COMPLEXITY_LAYERS_CN.md`（理念与分层定义）
- `docs/guides/DEPLOYMENT_MVP_WORKFLOW_CN.md`（上线闭环与验收范式）
...
你可以直接复用：`docs/guides/FEATURE_COMPLEXITY_LAYERS_CN.md` 的 Tier 定义。
