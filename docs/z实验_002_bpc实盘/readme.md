...
1. gate，evidence里面有大量数学特征，再次去掉，让数学特征专门去做 noise penalty，把实验报告直接保存到 [docs/z实验_002_bpc实盘](docs/z实验_002_bpc实盘)，方便以后复盘
...
16. 记录所有量化指标，输出最终实验报告到 docs/z实验_002_bpc实盘/
