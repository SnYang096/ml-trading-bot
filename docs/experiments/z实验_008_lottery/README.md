...
本目录汇总 **彩票层（高杠杆容量）** 的历史实验笔记与脚本入口；与 `docs/z实验_007_lv`（LV 清算语义）区分开：`007` 偏重 **Leverage Vulnerability archetype**，`008` 偏重 **L3 lottery + MAE/MFE 统计**。
...
## 与 `docs/z实验_007_lv` 的关系

v1–v3 报告最初写在 `docs/z实验_007_lv/`；现已 **复制** 至本目录作为彩票专题归档。`007` 下原文件可保留或日后删除，以你的习惯为准。
