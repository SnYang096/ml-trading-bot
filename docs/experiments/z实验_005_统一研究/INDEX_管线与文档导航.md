...
| Prefilter **研究方法论**与 **默认主路径**（研究+turbo+nonrolling；slow 可选） | [Prefilter研究方法论与管线分工.md](./Prefilter研究方法论与管线分工.md) | §3 制度化工作流；§1～2：树模型/OOS、边际联合、漂移护栏 |
...
- **方法论定稿**：Prefilter 特征发现与时间切分、边际/联合、多重比较等研究纪律见 [Prefilter研究方法论与管线分工.md](./Prefilter研究方法论与管线分工.md)（当前框架仍可加强）。
...
### 2.3 `rolling.mode: slow_realistic`（可选、低频）

- **默认不作为月度主链路**：建议主路径为 **前置研究定稿 archetypes → `turbo_fixed_features` rolling → nonrolling / 实施文档 03 类验收**；理由见 [Prefilter研究方法论与管线分工.md](./Prefilter研究方法论与管线分工.md) **第 3 节**。
- **保留用途**：季度 / 发版前 / 对照实验；观察结构刷新、`adoption_gate` 与 drift 护栏行为及与 turbo 的长期差异。
...
5. 若在定稿或扩展 **Prefilter**、或确认 **是否跑 slow**：读 [Prefilter研究方法论与管线分工.md](./Prefilter研究方法论与管线分工.md)（重点 **第 3 节** 默认主路径）。  
6. 发布前过 **本文 §4 Checklist**。
...
| [Prefilter研究方法论与管线分工.md](./Prefilter研究方法论与管线分工.md) | 研究机制、主路径（研究+turbo+nonrolling）、slow 可选定位、框架缺口 |
