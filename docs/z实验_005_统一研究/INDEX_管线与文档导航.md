...
| Prefilter **研究方法论**与 slow/turbo **分工** | [Prefilter研究方法论与管线分工.md](./Prefilter研究方法论与管线分工.md) | 树模型发现、OOS、边际/联合、多重比较、时间切分；与 drift/adoption 护栏的关系 |
...
5. 若在定稿或扩展 **Prefilter**：读 [Prefilter研究方法论与管线分工.md](./Prefilter研究方法论与管线分工.md)。  
...
| [Prefilter研究方法论与管线分工.md](./Prefilter研究方法论与管线分工.md) | Prefilter 研究机制必要性、与研究/turbo/slow 分工及框架缺口 |
