...
> 设计文档: `docs/z实验_005_统一研究/PCM宪法统一架构完整设计文档.md`
...
> **设计来源**: `docs/z实验_006_统一实盘/实盘监控系统设计.md` §B1 archetype_health
...
> 方法论文档: `docs/z实验_005_统一研究/统一建模方法论_meta_algorithm.md`
...
> 命令文档: `docs/z实验_006_统一实盘/本地研究pipeline命令.md`
...
> **设计文档**: `docs/z实验_005_统一研究/统一建模方法论_meta_algorithm.md`
...
| **Part B: 实盘部署**        | 🔨 进行中     | 详见 `docs/z实验_006_统一实盘/实盘部署TODO.md`                                                                                         |
