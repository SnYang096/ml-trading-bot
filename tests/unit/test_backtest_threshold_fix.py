...
if __name__ == "__main__":
    ...
    print("=" * 80)
    print("\n✅ 修复已完成：")
    print("  1. 更新了 config/strategies/bad-candidates/bpc/backtest.yaml")
    ...
    print("    --config config/strategies/bad-candidates/bpc \\")
    print("    --features config/strategies/bad-candidates/bpc/features_gate.yaml \\")
    print("    --labels config/strategies/bad-candidates/bpc/labels_rr_extreme.yaml \\")
