"""Regression: find_output_dir accepts per-strategy train_final layout."""
...
def test_find_output_dir_from_stdout_new_layout() -> None:
    text = (
        "Training done.\n"
...
def test_find_output_dir_glob_new_layout(tmp_path: Path, monkeypatch) -> None:
