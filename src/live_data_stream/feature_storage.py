...
class StorageManager:
    ...
    def __init__(
        ...
        self.tick_1min = Tick1MinStorage(base_path / "ticks")
    ...
    def save_1min_ticks(
        ...
        if timestamp is None:
            timestamp = pd.Timestamp.now(tz="UTC")
        trading_date = self.get_trading_date(timestamp)
        return self.tick_1min.append(symbol, trading_date, bars, include_incomplete)
    ...
    def warmup_load(
        ...
        return {
            ...
            "ticks_1min": self.tick_1min.load_range(symbol, start_date, end_date),
        }
    ...
    def get_recovery_state(
        ...
        Returns:
            ...
            - latest_1min_timestamp: 最新的1分钟bar时间戳
        ...
        latest_1min = self.tick_1min.get_latest_timestamp(symbol, trading_date)
        incomplete_bar = self.tick_1min.get_incomplete_bar(symbol, trading_date)
        
        return {
            "latest_15min_timestamp": latest_15min,
            "latest_1min_timestamp": latest_1min,
