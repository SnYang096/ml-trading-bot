...
Typical usage (from Makefile):
    ...
    PYTHONPATH=src python -m ml_trading.pipeline.workflows.auto_workflow \\
...
from ml_trading.pipeline.dimensionality import dimensionality_comparison as dim_compare
from ml_trading.pipeline.training import rolling as rolling_module
from ml_trading.pipeline.training import train as train_module
