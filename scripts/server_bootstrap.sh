...
echo "📋 你还需要做:"
echo ""
echo "  1. 上传 Binance API 密钥到服务器:"
echo "     scp live/binance_mainnet.env root@<IP>:$DEPLOY_PATH/live/"
echo ""
echo "  2. 准备 warmup 数据（首次需要，约需 5-10 分钟）:"
echo "     # 方式A: 从本地上传"
echo "     rsync -avz live/highcap/data/ticks/ root@<IP>:$DEPLOY_PATH/live/highcap/data/ticks/"
echo "     # 方式B: 服务器上直接下载（需要 Python 环境，可选）"
echo ""
...
echo ""
echo "  4. 首次手动部署（GitHub Actions 页面点 'Run workflow'）"
