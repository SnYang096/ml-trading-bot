...
switch ($choice) {
    ...
    "2" {
        ...
        Write-Host ""
        Write-Host "⚠️  警告: 这将下载约 177 个文件，可能需要数小时！" -ForegroundColor Yellow
        Write-Host ""
    ...
    "6" {
        ...
        python scripts/download_training_data.py --symbols $symbols.Split() --start-year $startYear --start-month $startMonth --end-year $endYear --end-month $endMonth
    }
...
Write-Host "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" -ForegroundColor Cyan
Write-Host ""
Write-Host "💡 提示: 下载的数据保存在 data/raw/ 目录" -ForegroundColor Cyan
Write-Host ""
