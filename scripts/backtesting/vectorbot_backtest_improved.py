"""Improved VectorBot backtest with better signal handling."""
...
class ImprovedVectorBotBacktest:
    ...
    def run_backtest(self, start_date: str = None, end_date: str = None):
        """Run the backtest."""
        print("🚀 Starting Improved VectorBot Backtest")
        print("=" * 50)
    ...
    def save_results(self):
        ...
        trades_df.to_csv("improved_vectorbot_trades.csv", index=False)

        # Save equity curve
        equity_df = pd.DataFrame(self.equity_curve)
        equity_df.to_csv("improved_vectorbot_equity_curve.csv", index=False)

        # Save results
        with open("improved_vectorbot_results.json", "w") as f:
            json.dump(self.results, f, indent=2)

        print(f"\n💾 Results saved:")
        print(f"   - improved_vectorbot_trades.csv")
        print(f"   - improved_vectorbot_equity_curve.csv")
        print(f"   - improved_vectorbot_results.json")
...
def main():
    ...
    # Initialize backtest
    backtest = ImprovedVectorBotBacktest(model_path, initial_capital=100000)
